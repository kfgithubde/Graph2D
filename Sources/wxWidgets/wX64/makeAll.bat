...
gfortran.exe   -m64  -m64   -I%wxBase%\include -I%wxBase%\lib\gcc_lib\mswu -c AG2.FOR -o obj\AG2.o
gfortran.exe   -m64  -m64   -I%wxBase%\include -I%wxBase%\lib\gcc_lib\mswu -c AG2Holerith.for -o obj\AG2Holerith.o
gfortran.exe   -m64  -m64   -I%wxBase%\include -I%wxBase%\lib\gcc_lib\mswu -c AG2uline.FOR -o obj\AG2uline.o
gfortran.exe   -m64  -m64   -I%wxBase%\include -I%wxBase%\lib\gcc_lib\mswu -c AG2umnmx.FOR -o obj\AG2umnmx.o
gfortran.exe   -m64  -m64   -I%wxBase%\include -I%wxBase%\lib\gcc_lib\mswu -c AG2upoint.FOR -o obj\AG2upoint.o
gfortran.exe   -m64  -m64   -I%wxBase%\include -I%wxBase%\lib\gcc_lib\mswu -c AG2users.FOR -o obj\AG2users.o
gfortran.exe   -m64  -m64   -I%wxBase%\include -I%wxBase%\lib\gcc_lib\mswu -c AG2useset.FOR -o obj\AG2useset.o
gfortran.exe   -m64  -m64   -I%wxBase%\include -I%wxBase%\lib\gcc_lib\mswu -c AG2usesetC.FOR -o obj\AG2usesetC.o
gfortran.exe   -m64  -m64   -I%wxBase%\include -I%wxBase%\lib\gcc_lib\mswu -c AG2UsrSoftek.FOR -o obj\AG2UsrSoftek.o
gfortran.exe   -m64  -m64   -I%wxBase%\include -I%wxBase%\lib\gcc_lib\mswu -c GetHDC.for -o obj\GetHDC.o
gfortran.exe   -m64  -m64   -I%wxBase%\include -I%wxBase%\lib\gcc_lib\mswu -c Graph2D.f08 -o obj\Graph2D.o
gfortran.exe   -m64  -m64   -I%wxBase%\include -I%wxBase%\lib\gcc_lib\mswu -c Strings.for -o obj\Strings.o
gfortran.exe   -m64  -m64   -I%wxBase%\include -I%wxBase%\lib\gcc_lib\mswu -c TCS.for -o obj\TCS.o
gfortran.exe   -m64  -m64   -I%wxBase%\include -I%wxBase%\lib\gcc_lib\mswu -c TCSdrWXfor.f08 -o obj\TCSdrWXfor.o

gfortran.exe   -m64  -m64   -I%wxBase%\include -I%wxBase%\lib\gcc_lib\mswu -c TCSdrWXcpp.cpp -o obj\TCSdrWXcpp.o

ar.exe -r libgraph2d.a obj\AG2.o obj\AG2Holerith.o obj\AG2uline.o obj\AG2umnmx.o obj\AG2upoint.o obj\AG2users.o obj\AG2useset.o obj\AG2usesetC.o obj\AG2UsrSoftek.o obj\GetHDC.o obj\Strings.o obj\TCS.o obj\TCSdrWXfor.o obj\TCSdrWXcpp.o
ranlib libgraph2d.a
